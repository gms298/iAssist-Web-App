...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    <h2><%: Title %> Yourself With Us</h2>
    <p class="text-danger">
        <asp:Literal runat="server" ID="ErrorMessage" />
    </p>

    <div class="form-horizontal">
        <h4>Create a new account by filling all details below ..</h4>
        <hr />
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="EmailID" CssClass="col-md-2 control-label">Email ID (Username)</asp:Label>
            <div class="col-md-10">
